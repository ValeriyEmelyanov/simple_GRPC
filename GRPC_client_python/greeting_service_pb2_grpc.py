...
class GreetingSericeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.greeting = channel.unary_unary(
                '/com.example.grpc.GreetingSerice/greeting',
...
class GreetingSericeServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_GreetingSericeServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'com.example.grpc.GreetingSerice', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class GreetingSerice(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def greeting(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.example.grpc.GreetingSerice/greeting',
